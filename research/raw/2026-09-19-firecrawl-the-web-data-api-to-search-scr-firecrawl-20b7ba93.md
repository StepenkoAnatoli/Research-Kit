...
command: firecrawl scrape https://www.firecrawl.dev/ --only-main-content --json
statusCode: 200
...
The web data API to search, scrape, and interact
...
4    "markdown": "# Getting Started...",\
5    "json": { "title": "Guide", "docs": "..." },\
...
Industry-leading reliability. 96% coverage on our 1,000-URL firecrawl/scrape-content-dataset-v1 benchmark, run Jan 13, 2026. Every query and URL comes back as clean data.

[See benchmarks](https://www.firecrawl.dev/alternatives#measured-performance)
...
Blazingly fast. P95 latency of 3,387 ms on the same 1,000-URL benchmark, run Jan 13, 2026, built for real-time agents and dynamic apps.

[See comparisons](https://www.firecrawl.dev/alternatives#measured-performance)
...
![User](https://www.firecrawl.dev/_next/image?url=%2Fassets-original%2Ffeatures%2Fcached-user.png&w=256&q=75&dpl=dpl_2URjAbVqrocxtaADnhGtkjgWHAH7)
...
Firecrawl is the web data API to search, scrape, and interact with the web at scale. One API to turn websites into clean, LLM-ready data. Ideal for AI companies looking to empower their LLM applications with web context
