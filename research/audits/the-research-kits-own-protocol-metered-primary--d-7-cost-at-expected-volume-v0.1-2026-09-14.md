---
title: "The research kit's own protocol: metered primary-source collection, provenance, and gate — D-7 Cost at expected volume"
topic: "The research kit's own protocol: metered primary-source collection, provenance, and gate"
slug: the-research-kits-own-protocol-metered-primary--d-7-cost-at-expected-volume
version: 0.1
...
fingerprint: 09ef718d-f3951dfd-a18db8b4
---

# The research kit's own protocol: metered primary-source collection, provenance, and gate — Subtopic D-7: Cost at expected volume (Audit v0.1)
...
This audit compiles 1 verified finding about **D-7 — Cost at expected volume** (subtopic of The research kit's own protocol: metered primary-source collection, provenance, and gate) from 1 primary-source page cached under `research/raw/`. Every relevant blocking unknown has primary-source evidence; none remain open. Top finding: Free plan: 10 /scrape and 10 /search requests per minute, 2 concurrent browsers, 50,000 max queued jobs..

## How to use this file

This file is a self-contained audit of the **D-7 — Cost at expected volume** subtopic. It can be pasted into an AI on its own; its parent main-topic audit (`the-research-kits-own-protocol-metered-primary-v0.1-2026-09-14.md`) covers the full project.
...
## Subtopic D-7 — Cost at expected volume  
_Status: COVERED_
...
2. This file covers subtopic **D-7 — Cost at expected volume** only. The main audit and sibling subtopic audits live alongside it in `research/audits/`.
...
- Scope: subtopic D-7 (Cost at expected volume)
