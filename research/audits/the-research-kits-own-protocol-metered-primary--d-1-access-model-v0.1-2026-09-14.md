---
title: "The research kit's own protocol: metered primary-source collection, provenance, and gate — D-1 Access model"
topic: "The research kit's own protocol: metered primary-source collection, provenance, and gate"
slug: the-research-kits-own-protocol-metered-primary--d-1-access-model
version: 0.1
generated: 2026-09-14T20:30:57.908Z
date: 2026-09-14
...
fingerprint: 09ef718d-f3951dfd-74d0afee
---

# The research kit's own protocol: metered primary-source collection, provenance, and gate — Subtopic D-1: Access model (Audit v0.1)
...
This audit compiles 1 verified finding about **D-1 — Access model** (subtopic of The research kit's own protocol: metered primary-source collection, provenance, and gate) from 1 primary-source page cached under `research/raw/`. Every relevant blocking unknown has primary-source evidence; none remain open. Top finding: Free plan: 10 /scrape and 10 /search requests per minute, 2 concurrent browsers, 50,000 max queued jobs..

## How to use this file

This file is a self-contained audit of the **D-1 — Access model** subtopic. It can be pasted into an AI on its own; its parent main-topic audit (`the-research-kits-own-protocol-metered-primary-v0.1-2026-09-14.md`) covers the full project.
...
2. This file covers subtopic **D-1 — Access model** only. The main audit and sibling subtopic audits live alongside it in `research/audits/`.
...
- Scope: subtopic D-1 (Access model)
