...
command: firecrawl scrape https://github.com/pricing --only-main-content --json
statusCode: 200
...
\\
\\
Compare plans](https://github.com/features/copilot/plans)
...
Create a custom estimate with the
