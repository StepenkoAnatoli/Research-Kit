...
command: firecrawl scrape https://docs.github.com/en/billing/concepts/product-billing/github-actions --only-main-content --json
statusCode: 200
transport: firecrawl-cli
completeness: full
title: GitHub Actions billing - GitHub Docs
---
[Skip to main content](https://docs.github.com/en/billing/concepts/product-billing/github-actions#main-content)

[Skip to content](https://docs.github.com/en/billing/concepts/product-billing/github-actions#main-content)
...
GitHub Actions usage is **free** for **self-hosted runners** and for **public repositories** that use standard GitHub-hosted runners. See [Choosing the runner for a job](https://docs.github.com/en/actions/how-tos/write-workflows/choose-where-workflows-run/choose-the-runner-for-a-job#standard-github-hosted-runners-for-public-repositories).
...
### [Copilot code review and GitHub Actions minutes](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#copilot-code-review-and-github-actions-minutes)
...
## [How storage billing works](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#how-storage-billing-works)
...
- **Shared storage:** Actions artifacts and GitHub Packages storage share the same pooled allowance. See [GitHub Packages billing](https://docs.github.com/en/billing/concepts/product-billing/github-packages).
...
### [Understanding current vs. accrued storage](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#understanding-current-vs-accrued-storage)
...
### [Storage measurement units](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#storage-measurement-units)
...
### [Custom image storage](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#custom-image-storage)
...
### [Examples of how usage is measured](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#examples-of-how-usage-is-measured)
...
## [Free use of GitHub Actions](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#free-use-of-github-actions)
...
## [Using more than your included quota](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#using-more-than-your-included-quota)
...
## [Paying for additional GitHub Actions use](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#paying-for-additional-github-actions-use)

You pay for any additional use above your quota using the payment method set up for your GitHub account. See [Managing your payment and billing information](https://docs.github.com/en/billing/how-tos/set-up-payment/manage-payment-info).
...
- To view your current costs, see [Viewing your usage of metered products and licenses](https://docs.github.com/en/billing/how-tos/products/view-productlicense-use).
...
### [Baseline minute costs](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#baseline-minute-costs)
...
For full details of minute costs for different types of runners, see [Actions runner pricing](https://docs.github.com/en/billing/reference/actions-runner-pricing).

### [Storage pricing](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#storage-pricing)
...
### [Example minutes cost calculation for GitHub-hosted runners](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#example-minutes-cost-calculation-for-github-hosted-runners)
...
### [Example artifact storage cost calculation](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#example-artifact-storage-cost-calculation)
...
### [Example cache storage cost calculation](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#example-cache-storage-cost-calculation)
...
## [Managing your budget for GitHub Actions](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#managing-your-budget-for-github-actions)

If your account does not have a valid payment method on file, usage is blocked once you use up your quota.

If you have a valid payment method on file, spending may be limited by one or more budgets. Check the budgets set for your account to ensure they are appropriate for your usage needs. See [Setting up budgets to control spending on metered products](https://docs.github.com/en/billing/how-tos/set-up-budgets).

You can also receive email notifications when your included GitHub Actions usage reaches 90% and 100% during a billing period. For more information, see [Budgets and alerts](https://docs.github.com/en/billing/concepts/budgets-and-alerts#included-usage-alerts).

## [Further reading](https://docs.github.com/en/billing/concepts/product-billing/github-actions\#further-reading)
