...
command: firecrawl scrape https://docs.github.com/en/rest/about-the-rest-api/api-versions --only-main-content --json
statusCode: 200
transport: firecrawl-cli
completeness: full
title: API Versions - GitHub Docs
---
[Skip to main content](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10#main-content)

[Skip to content](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10#main-content)
...
## [About API versioning](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#about-api-versioning)
...
## [Specifying an API version](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#specifying-an-api-version)
...
## [Upgrading to a new API version](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#upgrading-to-a-new-api-version)
...
## [API version closing down](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#api-version-closing-down)
...
For more information on migrating to a newer API version, see [Breaking changes](https://docs.github.com/en/rest/about-the-rest-api/breaking-changes).

## [Exceptions to standard versioning](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#exceptions-to-standard-versioning)
...
### [Security, availability, and reliability issues](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#security-availability-and-reliability-issues)
...
### [Low-usage services](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#low-usage-services)
...
## [Supported API versions](https://docs.github.com/en/rest/about-the-rest-api/api-versions?apiVersion=2026-03-10\#supported-api-versions)
