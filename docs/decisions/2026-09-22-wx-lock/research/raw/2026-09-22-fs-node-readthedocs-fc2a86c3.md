---
url: https://node.readthedocs.io/en/stable/api/fs/
retrieved: 2026-09-22
command: firecrawl scrape https://node.readthedocs.io/en/stable/api/fs/ --only-main-content --json
statusCode: 200
transport: firecrawl-cli
completeness: full
title: Fs - node
---
- [Docs](https://node.readthedocs.io/en/stable/) »
- Api »
- Fs
...
`stats` is a [fs.Stats](https://node.readthedocs.io/en/stable/api/fs/#fs_class_fs_stats) object. See the [fs.Stats](https://node.readthedocs.io/en/stable/api/fs/#fs_class_fs_stats)
...
[Buffer.byteLength](https://node.readthedocs.io/en/stable/api/buffer.html#buffer_class_method_buffer_bytelength_string_encoding).
...
directory. The returned object is a [fs.FSWatcher](https://node.readthedocs.io/en/stable/api/fs/#fs_class_fs_fswatcher).
...
instances of [Date](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date) object and to compare the values of
these objects you should use appropriate methods. For most general
uses [getTime()](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date/getTime) will return the number of
milliseconds elapsed since _1 January 1970 00:00:00 UTC_ and this
integer should be sufficient for any comparison, however there are
additional methods which can be used for displaying fuzzy information.
More details can be found in the [MDN JavaScript Reference](https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/Date)
page.
...
`ReadStream` is a [Readable Stream](https://node.readthedocs.io/en/stable/api/stream.html#stream_class_stream_readable).
...
`WriteStream` is a [Writable Stream](https://node.readthedocs.io/en/stable/api/stream.html#stream_class_stream_writable).
...
See more details in [fs.watch](https://node.readthedocs.io/en/stable/api/fs/#fs_fs_watch_filename_options_listener).
...
Versions[latest](https://node.readthedocs.io/en/latest/api/fs/)**[stable](https://node.readthedocs.io/en/stable/api/fs/)**On Read the Docs[Project Home](https://app.readthedocs.org/projects/node/?utm_source=node&utm_content=flyout)[Builds](https://app.readthedocs.org/projects/node/builds/?utm_source=node&utm_content=flyout)Search

* * *

[Addons documentation](https://docs.readthedocs.io/page/addons.html?utm_source=node&utm_content=flyout) ― Hosted by
[Read the Docs](https://about.readthedocs.com/?utm_source=node&utm_content=flyout)
