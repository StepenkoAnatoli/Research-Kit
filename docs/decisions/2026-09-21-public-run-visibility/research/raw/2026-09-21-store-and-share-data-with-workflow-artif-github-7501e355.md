...
command: firecrawl scrape https://docs.github.com/en/actions/tutorials/store-and-share-data --only-main-content --json
statusCode: 200
transport: firecrawl-cli
completeness: full
title: Store and share data with workflow artifacts - GitHub Docs
---
[Skip to main content](https://docs.github.com/en/actions/tutorials/store-and-share-data#main-content)

[Skip to content](https://docs.github.com/en/actions/tutorials/store-and-share-data#main-content)
...
## [Prerequisites](https://docs.github.com/en/actions/tutorials/store-and-share-data\#prerequisites)

Before you can complete this tutorial, you need to understand workflow artifacts. See [Workflow artifacts](https://docs.github.com/en/actions/concepts/workflows-and-actions/workflow-artifacts).

## [Uploading build and test artifacts](https://docs.github.com/en/actions/tutorials/store-and-share-data\#uploading-build-and-test-artifacts)
...
### [Example](https://docs.github.com/en/actions/tutorials/store-and-share-data\#example)
...
To display code coverage results directly on pull requests instead of downloading artifacts, you can upload a Cobertura XML coverage report to Code Quality. See [Setting up code coverage for your repository](https://docs.github.com/en/code-security/how-tos/maintain-quality-code/set-up-code-coverage).

## [Configuring a custom artifact retention period](https://docs.github.com/en/actions/tutorials/store-and-share-data\#configuring-a-custom-artifact-retention-period)
...
## [Downloading artifacts during a workflow run](https://docs.github.com/en/actions/tutorials/store-and-share-data\#downloading-artifacts-during-a-workflow-run)
...
## [Passing data between jobs in a workflow](https://docs.github.com/en/actions/tutorials/store-and-share-data\#passing-data-between-jobs-in-a-workflow)
...
The workflow run will archive any artifacts that it generated. For more information on downloading archived artifacts, see [Downloading workflow artifacts](https://docs.github.com/en/actions/how-tos/manage-workflow-runs/download-workflow-artifacts).

## [Validating artifacts](https://docs.github.com/en/actions/tutorials/store-and-share-data\#validating-artifacts)
