...
| | |
|---|---|
| `lib/` modules | **47** (43, plus the 4 extracted into `lib/release/`) — every one has a row above |
| `bin/` entrypoints | **28**, of which **4 are Python**: 3 conformance runners and the module they share |
| `schemas/` | **12** |
