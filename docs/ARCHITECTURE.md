...
> **One row above describes a module that does not exist here.**
>
> `path-authority-validator.mjs` is part of the
> release-evidence validator layer that ADR-0022 deferred. `release-validator.mjs` was
> ported on 2026-09-20 under ADR-0029 and is real; the other is not yet. This table
